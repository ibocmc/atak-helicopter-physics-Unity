...
public class HelicopterController : MonoBehaviour
{
	...
	public float EngineForce
    {
        ...
        set
        {
            MainRotorController.RotarSpeed = value * 50;
            SubRotorController.RotarSpeed = value * 100;
...
//                    if (EngineForce < 0) EngineForce = 0;
			//	if (Input.GetKey (KeyCode.C)) {
				...
				HelicopterModel.AddRelativeForce (Vector3.down * d_force * HelicopterModel.mass);
